                ...
                <div className="flex flex-col gap-4 shadow-lg py-8 px-6 mx-4 rounded-xl bg-[#F2F1EF] relative">
                  ...
                  <div className="flex flex-col items-center gap-4">
                    <div className="space-y-3">
                        ...
                        <h1 className="text-xl font-bold text-primary playfair-display-cursive">{data.name}</h1>
                    </div>
                  </div>

                  <p className="text-primary/40 text-8xl font-serif absolute top-0 right-1 ">,,</p>
                </div>
              </div>
            ))}
          </Slider>
